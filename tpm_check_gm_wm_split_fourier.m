...
for first = 1:length(four(1,1,:));
    for second = 1:length(four(1,:,1));
        for third = 1:length(four(:,1,1));
            if four(first,second,third) > 0;
